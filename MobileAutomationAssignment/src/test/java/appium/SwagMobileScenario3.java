...
public class SwagMobileScenario3{
	public static void main(String[] args) throws InterruptedException {
		...
		and.findElementByAccessibilityId("test-First Name").sendKeys("fname");
		and.findElementByAccessibilityId("test-Last Name").sendKeys("lname");
		and.findElementByAccessibilityId("test-Zip/Postal Code").sendKeys("12345");
